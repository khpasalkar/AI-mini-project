...
plot(ct, margin=0.05, compress=TRUE, uniform = TRUE)
text(ct, use.n=TRUE, pretty=1, all=TRUE, cex=0.6)
...
### plot
par(mar = c(1,1,2,0.5))
plot(ct2, margin=0.05, compress=TRUE, main="Decision Tree", uniform = TRUE)
text(ct2, use.n=TRUE, pretty=1, all=TRUE, cex=0.6)
summary(ct2)
